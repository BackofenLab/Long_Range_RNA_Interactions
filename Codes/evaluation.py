...
def draw_lineplots(df, extra_bases_roi, output, subopt_mode=False, draw_roi_box=False, vertical=False, meme_sites={}):
    """
    ...
    vertical (bool): If True, plots will be on top of each other instead of next to each other
    ...
    if vertical:
        fig, (side5, side3) = plt.subplots(2, 1, figsize=(24, 20)) # On top of each other
    else:
        fig, (side5, side3) = plt.subplots(1, 2, figsize=(16, 12)) # Next to each other
    ...
    if vertical:
        side3.legend(handles=legend_elements,loc="upper left", labelspacing=0.7, prop={"size": 16})
        side5.legend(handles=legend_elements,loc="upper left", labelspacing=0.7, prop={"size": 16})
    else:
        side5.legend(handles=legend_elements,loc="upper left", labelspacing=0.7, prop={"size": 12})
    #plt.suptitle("Interaction Lineplot", fontsize=48)
    plt.subplots_adjust(wspace=0.05)
    plt.savefig(output, bbox_inches='tight')
    
    # Save plots separately too: (Optional)
    if vertical:
